...
def radius_changed():
    ...
    canvas.coords(circle_item, x-100, y-100, x+100, y+100)
...
canvas.grid(row=1, rowspan=2, column=2)  

circle_item = canvas.create_oval(x-100, y-100, x+100, y+100, outline='#000000', fill='#00FFFF') 
######
